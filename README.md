# OpenFaaS Golang Custom Templates

This repository contains an OpenFaaS compatible template for generating an image with the top 1 
million sites. This is mostly proprietary so usage may vary for other users.
...
```bash
faas-cli template pull https://github.com/openrecce/golang-custom-templates
```
...
```
export OPENFAAS_PREFIX=https://github.com/openrecce/golang-custom-templates
export FN="tester"
faas-cli new --lang golang-middleware-top1m $FN
```
